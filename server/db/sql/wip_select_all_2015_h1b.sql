...
agent_attorney_state, job_title, soc_code, soc_name, naic_code,
...
wage_rate_of_pay, wage_rate_of_pay_from, wage_rate_of_pay_to,
h1b_dependent, willful_violator, worksite_city, worksite_county, worksite_state,
...
data->>'employer_address1' AS employer_address1,
data->>'employer_address2' AS employer_address2,
...
NULLIF(data->>'pw_wage_source_year', '')::int AS pw_wage_source_year,
data->>'pw_wage_source_other' AS pw_wage_source_other,
data->>'wage_rate_of_pay' AS wage_rate_of_pay,
...
FROM temp_table_2015s limit 10;