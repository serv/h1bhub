...
module.exports = (sequelize, DataTypes) => {
  const h1b2015 = sequelize.define(
    'h1b2015',
    {
      ...
      employer_address1: DataTypes.STRING,
      employer_address2: DataTypes.STRING,
      ...
      pw_wage_source_year: DataTypes.INTEGER,
      pw_wage_source_other: DataTypes.STRING,
      wage_rate_of_pay: DataTypes.STRING,
  ...
  h1b2015.associate = function(models) {
